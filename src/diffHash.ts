 ...
 * attestation as the anchor for the next incremental review (`git diff <sha>..HEAD` = what changed
 * since). Not the gate's validity key — that stays the content-based diffHash. */
